...
# <span style="font-size: 1.0em;">30分でわかる</br>アーキテクチャ</br>モダナイゼーション</span>
...
<div style="display: flex; gap: 15px; align-items: center; margin-bottom: 10px;">
<div style="width: 30%;">
<img src="../../assets/images/2026/figure-8-1-domain-discovery.png" alt="Domain Discovery" style="width: 100%; height: fit-content;">
<div style="font-size: 0.55em; color: #999; text-align: center; margin-top: 5px;">Figure 8.1 より引用</div>
</div>
<div style="flex: 1; background-color: #f5f5f5; padding: 10px; border-radius: 8px;">
